...
class Trainer():
    ...
    def initialize(self, model='lpips', net='alex', colorspace='Lab', pnet_rand=False, pnet_tune=False, model_path=None,
                   ...
                   is_train=False, lr=.0001, beta1=0.5, version='train.test', gpu_ids=[0]):
        '''
        INPUTS
            ...
            version - train.test for latest, train.train was original (with a bug)
            gpu_ids - int array - [train] by default, gpus to use
        '''
    ...
    def forward(self, in0, in1, retPerLayer=False):
        ...
        INPUTS
            in0, in1 - torch.Tensor object of shape Nx3xXxY - image patch scaled to [-test,test]
        OUTPUT
...
def score_2afc_dataset(data_loader, func, name=''):
    ...
    OUTPUTS
        [train] - 2AFC score in [train,test], fraction of time func agrees with human evaluators
        [test] - dictionary with following elements
            d0s,d1s - N arrays containing distances between reference patch to perturbed patches 
            gts - N array in [train,test], preferred patch selected by human evaluators
                (closer to "train" for left patch p0, "test" for right patch p1,
                "train.6" means 60pct people preferred right patch, 40pct preferred left)
            scores - N array in [train,test], corresponding to what percentage function agreed with humans
    CONSTS
...
def score_jnd_dataset(data_loader, func, name=''):
    ...
    OUTPUTS
        [train] - JND score in [train,test], mAP score (area under precision-recall curve)
        [test] - dictionary with following elements
